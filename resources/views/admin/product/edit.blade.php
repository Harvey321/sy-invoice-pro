                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sn" name="sn" value="{{$data->sn}}"
                                   class="form-control" placeholder="请输入产品序列号" maxlength="100" onkeyup="this.value=this.value.trim()">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">产品名:</label>
                            <input type="text" id="product_name" name="product_name" value="{{$data->product_name}}"
                                   class="form-control" placeholder="请输入产品名称" maxlength="100" onkeyup="this.value=this.value.trim()">
                        </div>
                        <div class="form-group">
